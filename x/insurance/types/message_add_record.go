...
func NewMsgAddRecord(creator string, brand string, model string, owner string, licencePlate string, vinNumber string, mileage string, side string, part string, payout string) *MsgAddRecord {
	return &MsgAddRecord{
		Creator:      creator,
		Brand:        brand,
		Model:        model,
