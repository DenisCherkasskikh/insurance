...
import (
	...
	"github.com/DenisCherkasskikh/insurance/testutil/sample"
	insurancesimulation "github.com/DenisCherkasskikh/insurance/x/insurance/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgAddRecord,
		insurancesimulation.SimulateMsgAddRecord(am.accountKeeper, am.bankKeeper, am.keeper),
	))
